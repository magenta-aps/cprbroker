    ...
    public partial class DatabaseSetupInfo
    {
        public static Dictionary<string, string> PropertyToRegistryMappings
        {
            get
            {
                ...
                ret.Add(Constants.ServerName, "ServerName");
                ret.Add(Constants.DatabaseName, "DatabaseName");
                ret.Add(Constants.UseExistingDatabase, "UseExistingDatabase");
                ret.Add(Constants.AdminIntegratedSecurity, "AdminIntegratedSecurity");
                ret.Add(Constants.AdminUsername, "AdminUserName");
                ret.Add(Constants.AppSameAsAdmin, "AppSameAsAdmin");
                ret.Add(Constants.AppIntegratedSecurity, "AppIntegratedSecurity");
                ret.Add(Constants.AppUsername, "AppUserName");
                return ret;
            }
        }
