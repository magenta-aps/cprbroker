...
namespace CprBroker.Tests.DPR.PersonTotalTests.ToPersonInfo
{
    ...
    class AddressTests : BaseTests
    {
        ...
        {
            var personTotal = new PersonTotalStub();
            var personAddress = new PersonAddressStub() { CorrectionMarker = correctionMarker };
        ...
        {
            var personTotal = new PersonTotalStub();
            var personAddress = new PersonAddressStub() { CorrectionMarker = null, AddressEndDate = endDate };
            personTotal.PersonAddresses.Add(personAddress);
            var personInfo = personTotal.ToPersonInfo();
        ...
        {
            var personTotal = new PersonTotalStub();
            var personAddress = new PersonAddressStub() { CorrectionMarker = null };
            personTotal.PersonAddresses.Add(personAddress);
            var personInfo = personTotal.ToPersonInfo();
            Assert.AreEqual(personAddress, personInfo.Address);
        }
        ...
        {
            var personTotal = new PersonTotalStub();
            var addressWithOlderStartDate = new PersonAddressStub() { CorrectionMarker = null, AddressStartDate = startDate - 1 };
            personTotal.PersonAddresses.Add(addressWithOlderStartDate);
            var addressWithRecentStartDate = new PersonAddressStub() { CorrectionMarker = null, AddressStartDate = startDate };
