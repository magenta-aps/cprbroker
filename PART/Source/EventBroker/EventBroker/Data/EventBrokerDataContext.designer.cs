...
namespace CprBroker.EventBroker.Data
{
    ...
    [global::System.Data.Linq.Mapping.TableAttribute(Name = "dbo.BirthdateSubscription")]
    public partial class CriteriaSubscription : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        [global::System.Data.Linq.Mapping.AssociationAttribute(Name = "Subscription_CriteriaSubscription", Storage = "_Subscription", ThisKey = "SubscriptionId", OtherKey = "SubscriptionId", IsForeignKey = true, DeleteOnNull = true, DeleteRule = "CASCADE")]
        public Subscription Subscription
        {
            get
            {
            ...
            set
            {
                            ...
                            || (this._Subscription.HasLoadedOrAssignedValue == false)))
                {
                    ...
                    if ((value != null))
                    {
                        value.CriteriaSubscription = this;
                        this._SubscriptionId = value.SubscriptionId;
                    }
                    else
                    {
	...
	public partial class Subscription : INotifyPropertyChanging, INotifyPropertyChanged
	{
        ...
        private EntityRef<CriteriaSubscription> _CriteriaSubscription;
    ...
    partial void OnDeactivatedChanging(DateTime value);
    partial void OnDeactivatedChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Criteria", DbType="XML NULL")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Created", DbType="Datetime NOT NULL", CanBeNull=false)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Deactivated", DbType="Datetime NULL", CanBeNull=true)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Subscription_BirthdateSubscription", Storage="_BirthdateSubscription", ThisKey="SubscriptionId", OtherKey="SubscriptionId", IsUnique=true, IsForeignKey=false)]
		public CriteriaSubscription CriteriaSubscription
		{
			get
			{
				return this._CriteriaSubscription.Entity;
			}
			set
			{
				CriteriaSubscription previousValue = this._CriteriaSubscription.Entity;
				if (((previousValue != value) 
							|| (this._CriteriaSubscription.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._CriteriaSubscription.Entity = null;
						previousValue.Subscription = null;
					}
					this._CriteriaSubscription.Entity = value;
					if ((value != null))
					{
						value.Subscription = this;
					}
					this.SendPropertyChanged("CriteriaSubscription");
				}
			}
		}
    ...
    partial void OnCreatedChanging(DateTime value);
    partial void OnCreatedChanged();
    partial void OnRemovedChanging(DateTime value);
    partial void OnRemovedChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Removed", DbType="Datetime NULL", CanBeNull=true)]
