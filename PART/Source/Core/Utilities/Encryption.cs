...
namespace CprBroker.Utilities
{
    ...
    public static class Encryption
    {
        ...
        {
            return EncryptObject(o, CprBroker.Utilities.Config.ConfigManager.Current.EncryptionAlgorithm);
        }
        ...
        {
            return DecryptObject<T>(encryptedData, CprBroker.Utilities.Config.ConfigManager.Current.EncryptionAlgorithm);
        }
