    ...
    public partial class DatabaseSetupInfo : BaseSetupInfo
    {
        ...
        internal bool AdminConnectionHasDboRights()
        {
            ...
            try
            {
                ...
                {
                    adminConnection.Open();
                    return Utilities.Sql.IsDatabaseRoleMember("db_owner", AdminAuthenticationInfo.EffectiveUserName, adminConnection);
                }
            }
            catch (Exception)
            {
                ...
                if (!AdminConnectionHasAdminRights())
                {
                    ...
                    if (TryOpenConnection(appConnectionWithDB))
                    {
                        if (!ApplicationAuthenticationInfo.IntegratedSecurity)
                        {
                            ...
                            if (Utilities.Sql.IsDatabaseRoleMember("db_owner", ApplicationAuthenticationInfo.EffectiveUserName, connection))
                            {
