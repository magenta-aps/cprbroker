...
namespace CprBroker.Tests.Schemas
{
    namespace VirkningTypeTests
    {
        ...
        public class DateRangeInclude
        {
            ...
            {
                VirkningType.DateRangeIncludes(startDate, endDate, effectDate, allowOpen);
            }
            ...
            public void DateRangeIncludes_Correct_ReturnsTrue(
                ...
                [Values(true, false)] bool allowOpen)
            {
                var result = VirkningType.DateRangeIncludes(startDate, endDate, effectDate, allowOpen);
                Assert.True(result);
            }
            ...
            {
                var result = VirkningType.DateRangeIncludes(null, endDate, effectDate, false);
                Assert.False(result);
            }
            ...
            {
                var result = VirkningType.DateRangeIncludes(null, endDate, effectDate, true);
                Assert.True(result);
            }
            ...
            {
                var result = VirkningType.DateRangeIncludes(startDate, null, effectDate, true);
                Assert.True(result);
            }
            ...
            {
                var result = VirkningType.DateRangeIncludes(null, null, effectDate, true);
                Assert.True(result);
            }
            ...
            {
                var result = VirkningType.DateRangeIncludes(null, null, effectDate, false);
                Assert.False(result);
            }
