...
namespace CprBroker.Engine
{
    ...
    /// </summary>
    public class AdminManager : RequestProcessor
    {
        #region Versioning management
        public BasicOutputType<ServiceVersionType[]> GetCapabilities(string userToken, string appToken)
        {
            var facade = new GetCapabilitiesFacadeMethod(appToken, userToken);
            return GetMethodOutput<ServiceVersionType[]>(facade);
        }
        public BasicOutputType<bool> IsImplementing(string userToken, string appToken, string methodName, string version)
        {
        ...
        public BasicOutputType<Schemas.DataProviderType[]> GetDataProviderList(string userToken, string appToken)
        {
        ...
        public BasicOutputType<bool> SetDataProviderList(string userToken, string appToken, DataProviderType[] dataProviders)
        {
        ...
        #region Application
        public BasicOutputType<ApplicationType> RequestAppRegistration(string userToken, string appToken, string name)
        {
            var facade = new RequestAppRegistrationFacadeMethod(name, appToken, userToken);
            return GetMethodOutput<ApplicationType>(facade);
        }

        public BasicOutputType<bool> ApproveAppRegistration(string userToken, string appToken, string targetAppToken)
        {
            var facade = new ApproveAppRegistrationFacadeMethod(targetAppToken, appToken, userToken);
            return GetMethodOutput<bool>(facade);
        }

        public BasicOutputType<ApplicationType[]> ListAppRegistrations(string userToken, string appToken)
        {
            var facade = new ListAppRegistrationsFacadeMethod(appToken, userToken);
            return GetMethodOutput<ApplicationType[]>(facade);
        }

        public BasicOutputType<bool> UnregisterApp(string userToken, string appToken, string targetAppToken)
        {
        ...
        public BasicOutputType<bool> Log(string userToken, string appToken, string text)
        {
