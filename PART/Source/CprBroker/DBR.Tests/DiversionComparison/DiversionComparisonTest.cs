        ...
        public virtual PropertyComparisonResult[] ExcludedPropertiesInformation
        {
            get
            {
                return new PropertyComparisonResult[] {
                    new PropertyComparisonResult("AJF","", ExclusionReason.CopiedFromNonMatching),
                    new PropertyComparisonResult("MYNKOD","", ExclusionReason.CopiedFromNonMatching),
                    new PropertyComparisonResult("ADRNVN","", ExclusionReason.CopiedFromNonMatching),
                    new PropertyComparisonResult("INDRAP","", ExclusionReason.LocalUpdateRelated),
                    new PropertyComparisonResult("FOEDMYNHAENSTART","", ExclusionReason.CopiedFromNonMatching),
                    new PropertyComparisonResult("KUNDENR","", ExclusionReason.LocalUpdateRelated),
                    new PropertyComparisonResult("FARSKABHAENSTART","", ExclusionReason.CopiedFromNonMatching),
                    new PropertyComparisonResult("AEGTEMRK","", ExclusionReason.CopiedFromNonMatching),
                    new PropertyComparisonResult("AEGTEDOK","", ExclusionReason.CopiedFromNonMatching),
                    new PropertyComparisonResult("FARSKABMYNNVN","", ExclusionReason.CopiedFromNonMatching),
                    new PropertyComparisonResult("TIDLKOMNVN","", ExclusionReason.CopiedFromNonMatching),
                    new PropertyComparisonResult("CIVMYN","", ExclusionReason.CopiedFromNonMatching),
                    new PropertyComparisonResult("STILLINGDTO","", ExclusionReason.CopiedFromNonMatching),

                    new PropertyComparisonResult("MORDOK","", ExclusionReason.CopiedFromNonMatching),
                    new PropertyComparisonResult("FARDOK","", ExclusionReason.CopiedFromNonMatching),
                    new PropertyComparisonResult("MORMRK","", ExclusionReason.CopiedFromNonMatching),
                    new PropertyComparisonResult("FARMRK","", ExclusionReason.CopiedFromNonMatching),
                    new PropertyComparisonResult("UDLANDADRDTO","", ExclusionReason.CopiedFromNonMatching),
                    new PropertyComparisonResult("PNRMRKHAENSTART","", ExclusionReason.LocalUpdateRelated),
                    new PropertyComparisonResult("TIDLPNRMRK", "Fails sometimes because HistoricalPNR's can be older than the 20-year limit for extracts, so they do not appear in the emulated database", ExclusionReason.InsufficientHistory),
                    new PropertyComparisonResult("KONTAKTADR_KOMKOD","", ExclusionReason.CopiedFromNonMatching),
                    ...
                    new PropertyComparisonResult("TILFLYDTOMRK","", ExclusionReason.CopiedFromNonMatching),
                    new PropertyComparisonResult("MYNTXT_CIV","", ExclusionReason.CopiedFromNonMatching),
