...
{
    class TestDBR : ConsoleEnvironment
    {
        public override string[] LoadCprNumbers()
        {
            UpdateFromeCprDirectFile(SourceFile);
            return new String[0];
        }
        public void UpdateFromeCprDirectFile(string dataFile)
        {
            ...
            CprConverter.ImportCprDirectFileInSteps(dataStream, SourceFile, 20, Encoding.GetEncoding(1252), BrokerConnectionString);
            dataStream.Close();
