...
{
    namespace GetUuidArraySubMethodInfoTests
    {
        [TestFixture]
        public class AreConsistentUuids
        {
            public class GetUuidArraySubMethodInfoStub : GetUuidArraySubMethodInfo
            {
                public GetUuidArraySubMethodInfoStub()
                    : base(new string[]{})
                { }
            }
            [Test]
            ...
            {
                Assert.True(new GetUuidArraySubMethodInfoStub().IsConsistentOutput(
                    new string[] { },
                    new string[] { }
                ));
            }
            ...
            public void AreConsistentUuids_Two_False()
            {
                ...
                Assert.False(new GetUuidArraySubMethodInfoStub().IsConsistentOutput(
                    new string[] { pnr, pnr },
                    new string[] { Guid.NewGuid().ToString(), Guid.NewGuid().ToString() }
                ));
            }
