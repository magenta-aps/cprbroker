...
namespace CprBroker.Web.Services
{
    ...
    public class Admin : WebService
    {
        ...
        {
            return AdminManager.RequestAppRegistration(Utilities.Constants.UserToken, Utilities.Constants.BaseApplicationToken.ToString(), ApplicationName);
        }
        ...
        {
            return AdminManager.ApproveAppRegistration(applicationHeader.UserToken, applicationHeader.ApplicationToken, ApplicationToken);
        }
        ...
        {
            return AdminManager.ListAppRegistrations(applicationHeader.UserToken, applicationHeader.ApplicationToken);
        }
        ...
        {
            return AdminManager.UnregisterApp(applicationHeader.UserToken, applicationHeader.ApplicationToken, ApplicationToken);
        }
        #endregion
        ...
        {
            return AdminManager.GetCapabilities(applicationHeader.UserToken, applicationHeader.ApplicationToken);
        }
        ...
        {
            return AdminManager.IsImplementing(applicationHeader.UserToken, applicationHeader.ApplicationToken, serviceName, serviceVersion);
        }
        #endregion
        ...
        {
            return AdminManager.GetDataProviderList(applicationHeader.UserToken, applicationHeader.ApplicationToken);
        }
        ...
        {
            return AdminManager.SetDataProviderList(applicationHeader.UserToken, applicationHeader.ApplicationToken, DataProviders);
        }
        #endregion
        ...
        {
            return AdminManager.Log(applicationHeader.UserToken, applicationHeader.ApplicationToken, Text);
        }
