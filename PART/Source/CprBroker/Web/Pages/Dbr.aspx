...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="Contents">
    ...
    OnRowCommand="grdDbr_RowCommand" OnRowDeleting="grdDbr_RowDeleting"
    OnRowEditing="grdDbr_RowEditing" OnRowCancelingEdit="grdDbr_RowCancelingEdit" OnRowUpdating="grdDbr_RowUpdating" DataKeyNames="QueueId">
        <EmptyDataTemplate>
