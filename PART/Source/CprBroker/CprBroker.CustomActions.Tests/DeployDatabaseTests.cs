...
namespace InstallerActions.Tests
{
    [TestFixture]
    public class DeployDatabaseTests
    {
        [Test]
        public void DeployCprDatabase_OK()
        {
            // Prepare SQL scripts
            ...
            lookupDataArray["CPR"] = CprBroker.CustomActions.Properties.ResourcesExtensions.Lookups;
