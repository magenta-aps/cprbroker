...
create table DataProviderCall (ID uniqueidentifier, ActivityID uniqueidentifier not null primary key, Time datetime, ProviderType varchar, Cost decimal, Operation varchar, Input varchar, Success bit)
