...
{
    public partial class WebSiteForm : BaseForm
    {
        ...
        {
            InstallationInfo.CreateNewWebSite = newWebSiteRadio.Checked;
        ...
        protected override bool ValidateContents()
        {
            ...
            {
                string message = InstallationInfo.CreateNewWebSite ? Messages.WebsiteExists : Messages.WebAppExists;
